...
//                 <li className="breadcrumb-item"><Link to="/"><i className="fa-solid fa-house"></i></Link></li>
//                 {/*<li className="breadcrumb-item"><a href="#">Library</a></li>*/}
//                 <li className="breadcrumb-item active" aria-current="page">Page Name (open)</li>
//             </ol>
//         </nav>
//         </div>)
// }
    ...
    //                 <li className="breadcrumb-item"><Link to="/"><i className="fa-solid fa-house"></i></Link>
    //                 </li>
    //                 <li className="breadcrumb-item active" aria-current="page">By
    //                         Location: {byLocationsPageName}</li>
    //                 <li className="breadcrumb-item active" aria-current="page">By
    //                         Props: {props.byPropsPageName}</li>
    //                 <li className="breadcrumb-item active" aria-current="page">By
    //                         Context: {byContextPageName}</li>
    //         </ol>
    // </nav>)
